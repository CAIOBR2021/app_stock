...
const TIPO_OPTIONS: { value: TipoRelatorio; label: string; descricao: string }[] = [
  ...
  {
    value: 'critico',
    label: 'Abaixo do mínimo (crítico)',
    descricao: 'Produtos com quantidade ≤ estoque mínimo',
  },
  {
    value: 'prioritarios',
    label: 'Prioritários',
    descricao: 'Produtos marcados com flag de prioridade',
  },
];
